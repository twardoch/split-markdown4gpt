...
Welcome to `split_markdown4gpt` contributor's guide.
...
If you experience bugs or general issues with `split_markdown4gpt`, please have a look
...
You can help improve `split_markdown4gpt` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`split_markdown4gpt` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `split_markdown4gpt`'s files. While this mechanism can
...
```
conda create -n split_markdown4gpt python=3 six virtualenv pytest pytest-cov
conda activate split_markdown4gpt
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/split_markdown4gpt.git
   cd split_markdown4gpt
   ```
...
5. Install [pre-commit]:
   ...
   `split_markdown4gpt` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/split_markdown4gpt
[issue tracker]: https://github.com/<USERNAME>/split_markdown4gpt/issues
